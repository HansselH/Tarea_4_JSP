<%-- 
    Document   : index
    Created on : 5/10/2024, 2:00:06 p. m.
    Author     : Hanssel
--%>
    ...
    <div class="modal-content">      
      <div class="modal-body">
          <form action="sr_empleado" method="post" class="form-group">
                ...
                <label for="lbl_nombres"><b>Codigo:</b></label>
                ...
                <button type="button" class="btn btn btn-warning btn-lg " data-dismiss="modal">Cerrar</button> 
          </form>
      </div>
